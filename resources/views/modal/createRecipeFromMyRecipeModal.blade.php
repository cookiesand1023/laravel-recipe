    ...
    <div class="modal-content">
      ...
      <div class="modal-body py-2 px-4">
        <div class="form-floating">
            <div class="mb-3">
              <label for="recipe_URL" class="form-label mt-3">動画URL<i class="fa-brands fa-youtube mx-1 fa-lg"></i></label>
                <input type="text" class="form-control" placeholder="URL" id="recipe_URL" autocomplete="off">
              <div class="text-center d-grid">
                <button type="button" class="btn btn-getThumb mt-3 rounded-pill" id="getThumbnail"> ⇩ 動画のタイトルとサムネイルを取得</button>
              </div>
              ...
              <label for="book_ctg" class="form-label mt-3">カテゴリー</label>
                <select class="form-select w-50" id="recipe_ctg" placeholder="カテゴリーを選択">
              ...
              <label for="evaluation" class="form-label mt-3">評価</label>
                <div class="evaluation" id="recipe_value" name="recipe_value">
              ...
              <textarea class="form-control" placeholder="コツやアレンジなど" id="recipe_detail" autocomplete="off"></textarea>
              <input type="hidden" id="video_title" value="">
              <input type="hidden" id="video_description" value="">
            </div>
        </div>
      </div>
      <div class="modal-footer">
          <button type="button" class="btn btn-purple" id="addRecipeFromRecipes">追加</button>
